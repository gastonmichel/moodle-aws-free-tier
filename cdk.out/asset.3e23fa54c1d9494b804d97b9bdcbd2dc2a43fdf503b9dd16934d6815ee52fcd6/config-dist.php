...
$CFG->dbtype    = getenv('MOODLE_DOCKER_DB_TYPE');      // 'pgsql', 'mariadb', 'mysqli', 'auroramysql', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = getenv('MOODLE_DOCKER_DB_HOST');  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = getenv('MOODLE_DOCKER_DB_NAME');     // database name, eg moodle
$CFG->dbuser    = getenv('MOODLE_DOCKER_DB_USER');   // your database username
$CFG->dbpass    = getenv('MOODLE_DOCKER_DB_PASS');   // your database password
